...
public:
	...
	static SqlConnection^ Con = gcnew SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\\Facebook DB\\Facebook Management System.mdf;Integrated Security=True;Connect Timeout=30");
	static void load();
